...
<body>
    <div class="w3-content w3-mobile w3-white w3-panel">
        ...
        <ul class="programma">
            ...
            <li>
                <b>26 september:</b> Concert voor fluit en harp in C KV 299 voor 2 hobo's, 1 fagot, 2 hoorns en strijkers. Solisten zijn: Elisa Bartolomé Gómez, dwarsfluit, en Maria Palma, harp. <a href="/2026-09-26/kv299.php" target="_blank">Meer info & partijen vind je hier</a>. Er zijn nog enkele vacatures voor violen en altviool.
            </li>
            <li>
