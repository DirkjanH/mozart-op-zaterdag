...
<body>
    <div class="w3-content w3-white w3-panel">
        ...
        <p>De symfonie duurt ca. 26 minuten. De bezetting is 2 hobo's, 1 fagot, 2 hoorns en strijkers (minimaal 3.3.2.2.1). <a href="kv201.htm" target="_blank">De partijen vind je hier</a>. Voor de strijkers komt daar binnenkort ook een betekende partituur, met het verzoek de streken even over te nemen in je eigen partij.</p>
        <h4>Volgende afleveringen van Mozart op Zaterdag</h4>
        <p>Het is mogelijk je op te geven voor de volgende afleveringen. Het is de bedoeling hier een maandelijkse traditie van te maken op de vierde zaterdag van de maand. Dus de volgende keren zijn op 22 maart, 26 april en 24 mei, en daarna weer op 27 september, 25 oktober en 22 november. We hopen dat je dan deze geweldige muziek met ons wilt spelen! <a href="https://forms.gle/49YfM2dSn8AYpzfE8" target="_blank">In dit formulier kun je aangeven of je wilt meedoen</a>. Mogelijk zijn er meer inschrijvingen dan plaatsen. <b>Reageer daarom snel!</b></p>
        ...
        <p>Heb je belangstelling om eens mee te doen met Mozart op Zaterdag? We formeren een bezetting van serieuze en ervaren spelers die zich natuurlijk goed voorbereiden. We leveren op tijd (betekende) partijen als PDF's aan. Deelname is gratis; wel worden de deelnemers aan het eind om een vrijwillige bijdrage in de kosten van de zaal e.d. gevraagd. T.z.t. hopen we de professionele deelnemers ook wat te kunnen betalen.</p>
    </div>
</body>
