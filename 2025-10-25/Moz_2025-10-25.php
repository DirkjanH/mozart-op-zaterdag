...
<body>
    <div class="w3-content w3-white w3-panel">
        ...
        <h4>Deelnemers</h4>
        <p>De bezetting is bijna compleet. We hebben nu 30 mensen kunnen plaatsen, een mengeling van goede amateurs en professionals. Er is nog plaats voor een trompet en twee 2e violen.</p>
