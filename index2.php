...
<body>
    <div class="w3-container w3-mobile" style="width: 100%; max-width: 1000px;">
        ...
        <div class="w3-content w3-white w3-panel">
            <h2>Mozart op Zaterdag</h2>
                ...
                <p>We hopen dat je deze geweldige muziek met ons wilt spelen! We formeren een bezetting van serieuze en ervaren spelers die zich natuurlijk goed voorbereiden. We leveren op tijd (betekende) partijen als PDF's aan.
                    <a href="https://forms.gle/49YfM2dSn8AYpzfE8" target="_blank">In dit formulier kun je aangeven of en wanneer je wilt meedoen</a>. Mogelijk zijn er meer inschrijvingen dan plaatsen.
                    <b>Reageer daarom snel!</b> Deelname is gratis; wel worden de deelnemers aan het eind om een vrijwillige bijdrage in de kosten van de zaal e.d. gevraagd. T.z.t. hopen we de professionele deelnemers ook wat te kunnen betalen.
                </p>
                ...
                <ul>
                    ...
                    <a href="Moz_2025-04-26.htm">Meer info & partijen vind je hier</a>
                    <li>
                        <b>24 mei</b> in de
                        <a href="/marnixzaal.htm" target="_blank">Marnixzaal</a>: Symfonie nr. 15 in G-groot KV 124 (14') voor 2 hobo's, 1 fagot, 2 hoorns en strijkers en het vioolconcert nr. 4 in D KV 218 (solist: Evelyn Tjon-En-Fa)
                    </li>
                    <li>
